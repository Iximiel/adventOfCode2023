...
let test_power s res () =
  Alcotest.(check int)
    "same number" res
    (BagOcubes.getExtractions s |> BagOcubes.minimumBag |> BagOcubes.gamePower)
    ...
    [
      ...
      ( "Games power",
        [
          test_case "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green"
            `Quick
            (test_power "Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green"
               48);
          test_case
            "Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue"
            `Quick
          ...
          test_case "Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"
            `Quick
            (test_power "Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"
               36);
        ] );
    ]
